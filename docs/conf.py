...
_short_description = u'Smipyping - A python package for testing wbem servers'
...
version = package_version('../smipyping/_version.py', '__version__')
...
exclude_patterns = ["tests", ".tox", ".git", "attic", "dist", "irecv",
                    "tools", "packaging", "build_doc", "smipyping.egg-info",
                    ".eggs"]
...
extlinks = {
  'nbview': ('http://nbviewer.jupyter.org/github/smipyping/smipyping/blob/master/docs/notebooks/%s', ''),
  'nbdown': ('https://github.com/smipyping/smipyping/raw/master/docs/notebooks/%s', '')
}
