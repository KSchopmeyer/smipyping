...
class CLITestsBase(object):
    ...
    def subcmd_test(self, desc, subcmd, args, env, exp_response, condition):
        ...
        by args. This can execute smicli either with a mock environment
        ...
        of smicli using the exp_response parameter.
        ...
        Parameters:
          ...
          subcmd (:term:`string`):
            smicli subcommand inserted for this test.  This is the first
          ...
          exp_response (:class:`py:dict`)
            ...
            Includes the following possible keys:
               ...
               'rc' expected exit_code from smicli.  If None, code 0
               is expected.
        ...
        rc, stdout, stderr = execute_smicli(cmd_line)
